...
df.columns = ['species','alcohol','malic_acid','ash','alcalinity as','magnesium']
# 查看前5条数据
df.head()
print(df.head()) 
...
all_inputs = df[['alcohol','malic_acid','ash','alcalinity as','magnesium']].values
...
graph.write_pdf("frenchwine.pdf") 
